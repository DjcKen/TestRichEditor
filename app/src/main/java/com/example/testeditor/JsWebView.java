...
public class JsWebView extends WebView {
	...
	public void loadCSS(String cssFile) {
		String jsCSSImport = "(function() {" + "    var head  = document.getElementsByTagName(\"head\")[0];" + "    var link  = document.createElement(\"link\");" + "    link.rel  = \"stylesheet\";"
	...
	public void deleteHeading(int heading){
		exec("javascript:RE.deleteHeading('" + heading + "');");
	}
	...
	public void insertImage(String url, String alt,int ran, int w, int h) {
		exec("javascript:RE.prepareInsert();");
		exec("javascript:RE.insertImage('" + url + "', '" + alt + "', '" + ran +"', '" + w + "', '" + h + "');");
	}
	...
	public void deleteImage(Object obj) {
		exec("javascript:RE.deleteImage('"+obj+"');");
	}
